/**
 * Custom Command Plugin - C++ Implementation for Linux
 * 
...
static bool execute_linux_command(const char* command, char* output, size_t output_len) {
...
EXPORT bool plugin_execute_command(const char* command, char* output, size_t output_len) {
    ...
    bool success = execute_linux_command(command, output, output_len);
