...
async fn load_configuration(matches: &clap::ArgMatches) -> Result<core_shared::AgentConfig> {
...
async fn connect_to_broker(matches: &clap::ArgMatches, config: &core_shared::AgentConfig) -> Result<BrokerClient> {
    ...
    broker_client.publish_agent_registration(&core_shared::AgentInfo {
        id: agent_id.clone(),
...
async fn process_events(
    ...
    mut event_receiver: tokio::sync::mpsc::UnboundedReceiver<core_shared::EventMessage>,
) {
