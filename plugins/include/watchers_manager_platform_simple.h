/**
 * @file watchers_manager_platform_simple.h
 * @brief Simplified platform abstraction for Watchers Manager
 */

#ifndef WATCHERS_MANAGER_PLATFORM_SIMPLE_H
#define WATCHERS_MANAGER_PLATFORM_SIMPLE_H
...
// Platform-agnostic watcher context
typedef struct {
    char watch_path[512];
    bool is_active;
    void* platform_handle;  // Opaque handle for platform-specific data
...
#endif // WATCHERS_MANAGER_PLATFORM_SIMPLE_H
