/**
 * @file watchers_manager_linux_simple.c
 * @brief Simplified Linux implementation for Watchers Manager Plugin
 */
...
plugin_result_t linux_process_events(watcher_context_t* context, watcher_event_t* events, size_t* event_count) {
    ...
    linux_watcher_data_t* data = (linux_watcher_data_t*)context->platform_handle;
