/**
 * @file watchers_manager_windows_simple.c
 * @brief Simplified Windows implementation for Watchers Manager Plugin
 */

#include "../../include/plugin_interface_common.h"
#include "../../include/semantic_types.h"
#include "../../include/watchers_manager_platform_simple.h"
#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
plugin_result_t windows_init_watcher(watcher_context_t* context) {
    ...
    context->platform_handle = win_data;
...
plugin_result_t windows_start_watching(watcher_context_t* context) {
    if (!context || !context->platform_handle || !context->is_active) {
        return PLUGIN_RESULT_INVALID_PARAM;
    }
    
    windows_watcher_data_t* win_data = (windows_watcher_data_t*)context->platform_handle;
...
plugin_result_t windows_stop_watching(watcher_context_t* context) {
    if (!context || !context->platform_handle) {
        return PLUGIN_RESULT_INVALID_PARAM;
    }
